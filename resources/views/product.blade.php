<x-guest-layout>
    <main class="flex items-center justify-center p-8">
        <section class="w-full grid md:grid-cols-2 gap-3">
            ...
            <div class="self-center space-y-4">
                <h2 class="font-primary font-bold text-2xl md:text-4xl">Vestido Ana</h2>
                <p class="font-secondary text-secondary text-lg md:text-xl font-semibold">$1,000MXN</p>
                <div>
                    <h5 class="font-secondary text-xl font-semibold mb-2">Tamaño</h5>
                    <div class="flex items-center gap-3 uppercase">
                        <div class="border rounded border-secondary px-4 py-2 hover:bg-secondary hover:text-white duration-300">ch</div>
                        <div class="border rounded border-secondary px-4 py-2 hover:bg-secondary hover:text-white duration-300">md</div>
                        <div class="border rounded border-secondary px-4 py-2 hover:bg-secondary hover:text-white duration-300">gd</div>
                        <div class="border rounded border-secondary px-4 py-2 hover:bg-secondary hover:text-white duration-300">xg</div>
                    </div>
                </div>
                <div>
                    <h5 class="font-secondary text-xl font-semibold mb-2">Color</h5>
                ...
                <div>
                    <h5 class="font-secondary text-xl font-semibold mb-2">Cantidad</h5>
                    <input class="py-1 px-2 w-20 outline-none focus:ring-secondary focus:border-secondary duration-300 rounded border" type="number">
                </div>
                <div class="flex items-start gap-1">
                    ...
                    <h4 class="font-secondary">Pickup disponible en <span class="font-bold">Calle 40 x 47 y 49 238A, 97780, Valladolid, Yucatán</span></h4>
                </div>
    ...
    <a class="font-primary font-semibold inline-flex items-center mt-4 group w-fit text-base md:text-lg mx-8 mb-8 hover:text-secondary" href="{{url('/products')}}">
